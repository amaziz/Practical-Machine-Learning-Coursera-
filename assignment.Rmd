...
```
Applying the model on the training set shows the *fitting* capability of the model. Balanced accuract is 1.0  for all claseses. 
...
```
Applying the model on the probing set shows the *prediction* capability of the model. Balanced accuract is 1.0  for all claseses. 
